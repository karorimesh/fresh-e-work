...
This app was created with [Bootify.io](https://bootify.io/app/XMB0L6A0RCPU) - tips on working with the code [can be found here](https://bootify.io/next-steps/).
...
```
java -Dspring.profiles.active=production -jar ./target/customer-service-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/customer-service
```
